...
public class SatBeamScraper extends WebsiteData {
    ...
    public SatBeamScraper() {
    	try {
    		List<SatBeam> SatBeamObjList = ScrapeData(1, 608, "active");
    		List<WebsiteData.Satellite> SatBeamSats = SatBeamListToSatellites(SatBeamObjList);
    		this.setSatellites((ArrayList<Satellite>) SatBeamSats);
    	}catch (Exception er) {
    		System.out.println("Bład przy scrapowaniu SatBeam: " + er.getMessage());
    	}
    }
...
//                                    System.out.println("Link: " + "https://www.satbeams.com" + aLinkHref.getFirst().attr("href"));
                                        String link = "https://www.satbeams.com" + aLinkHref.get(0).attr("href");
                                        try{
